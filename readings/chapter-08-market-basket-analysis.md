...
<!-- [IMAGE: images/ch08/fig-8-0-mba-network-discovery.png]
Alt text: A young woman in a green utility jacket examines a glowing holographic network graph of connected product nodes floating in a dimly lit analytics lab.
Nano Banana Pro Prompt: "A Haitian-American woman in her early 20s with natural hair styled in a short tapered cut, wearing a forest-green utility jacket over a black crew-neck tee, stands in a dimly lit modern analytics lab. She leans slightly forward with one hand raised, fingertips nearly touching a large holographic network graph floating at chest height in front of her. The network consists of approximately twenty glowing nodes — each node is a small translucent sphere in varying sizes, the largest nodes glowing warm amber and the smaller ones cool electric blue. Connecting the nodes are luminous threads of varying thickness: the thickest threads glow bright amber (strong associations) while thinner threads are faint blue (weak associations). Three nodes in the upper-right cluster are noticeably brighter and more tightly connected than the rest, drawing the eye as the strongest association group. Her face is lit from below and in front by the amber-and-blue glow of the holographic network, casting soft upward light across her chin and cheekbones. A secondary cool blue ambient light fills the room from recessed ceiling panels. Behind her, a wide curved monitor on the wall shows a faint support-vs-confidence scatter plot with dozens of small dots, mostly dim, with three bright amber dots in the upper-right quadrant. The lab has dark charcoal walls, a glass-top standing desk to her left with a closed laptop and a single takeout coffee cup, and a narrow vertical window on the far right showing a predawn navy-blue sky. Style: modern tech editorial illustration with crisp vector-influenced rendering, subtle gradients, and a dark navy-and-electric-blue color palette with amber accents. Composition is a medium shot centered on the woman and the holographic network, with the network occupying the central third of the frame and her figure offset slightly to the left. The three bright nodes in the upper-right cluster are the focal point. No text or labels anywhere in the image."
-->
